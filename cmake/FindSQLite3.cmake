...
IF ( NOT SQLITE3_FOUND AND NOT PKG_CONFIG_FOUND )
	...
	IF ( _sqlite3_FOUND )
		SET ( SQLITE3_INCLUDE_DIR ${_sqlite3_include_DIR} )
		SET ( SQLITE3_LIBRARIES ${_sqlite3_link_DIR} )
	ENDIF ( _sqlite3_FOUND )

	# Report results
	IF ( SQLITE3_LIBRARIES AND SQLITE3_INCLUDE_DIR AND _sqlite3_FOUND )	
		SET( SQLITE3_FOUND 1 )
		IF ( NOT Sqlite3_FIND_QUIETLY )
			MESSAGE( STATUS "Found sqlite3: ${SQLITE3_LIBRARIES} ${SQLITE3_INCLUDE_DIR}" )
		ENDIF ( NOT Sqlite3_FIND_QUIETLY )
	ELSE ( SQLITE3_LIBRARIES AND SQLITE3_INCLUDE_DIR AND _sqlite3_FOUND )	
		IF ( Sqlite3_FIND_REQUIRED )
		...
		ELSE ( Sqlite3_FIND_REQUIRED )
			...
			ENDIF ( NOT Sqlite3_FIND_QUIETLY )
		ENDIF ( Sqlite3_FIND_REQUIRED )
	ENDIF ( SQLITE3_LIBRARIES AND SQLITE3_INCLUDE_DIR AND _sqlite3_FOUND )	
